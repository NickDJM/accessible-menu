...
describe("Menubar (custom arguments)", () => {
  // Test that the Menubar will initialize if a valid menuItemSelector is passed.
  ...
  // Test that the Menubar will throw an error if an invalid menuItemSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid menuLinkSelector is passed.
  ...
  // Test that the Menubar will throw an error if an invalid menuLinkSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid submenuItemSelector is passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenuItemSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenuToggleSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Menubar will initialize if a valid submenuSelector is passed when the submenuItemSelector is also passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenuSelector is passed when the submenuItemSelector is also passed.
