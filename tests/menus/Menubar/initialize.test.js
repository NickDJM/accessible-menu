/**
 * Initialization tests for the Menubar class.
 *
 * These tests are mostly covered by other tests, but are here just to ensure
 * that the Menubar class can be initialized.
 */
...
// Test the Menubar initialization.
describe("Menubar", () => {
  // Test that the Menubar will initialize if the menuElement passed.
  ...
  // Test that the Menubar will throw an error if no menuElement is passed.
  ...
  // Test that the Menubar will throw an error if the menuElement is invalid.
...
// Test the Menubar initialization for a controlled menu.
describe("Menubar (controlled)", () => {
  // Test that the Menubar will initialize if the menuElement passed.
  it("should initialize", () => {
    // Create the test menu.
    document.body.innerHTML = singleLevel;
  ...
  // Test that the Menubar will throw an error if no containerElement is passed when a controllerElement is.
  ...
  // Test that the Menubar will throw an error if the containerElement is invalid when a controllerElement is.
  ...
  // Test that the Menubar will throw an error if no controllerElement is passed when a containerElement is.
  ...
  // Test that the Menubar will throw an error if the controllerElement is invalid when a containerElement is.
...
// Test the Menubar media query handling.
describe("Menubar (media queries)", () => {
...
// Test the Menubar initialization with custom arguments.
describe("Menubar (custom arguments)", () => {
  // Test that the Menubar will initialize if a valid menuItemsSelector is passed.
  it("should initialize with a valid menuItemsSelector", () => {
    // Test that the menu initializes.
    expect(() => {
      // Create the Menubar instance for testing.
      new Menubar({
        menuElement: document.querySelector("ul"),
  ...
  // Test that the Menubar will throw an error if an invalid menuItemsSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid menuLinksSelector is passed.
  ...
  // Test that the Menubar will throw an error if an invalid menuLinksSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid submenuItemsSelector is passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenuItemsSelector is passed.
  ...
  // Test that the Menubar will initialize if a valid submenuTogglesSelector is passed when the submenuItemsSelector is also passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenuTogglesSelector is passed when the submenuItemsSelector is also passed.
  ...
  // Test that the Menubar will initialize if a valid submenusSelector is passed when the submenuItemsSelector is also passed.
  ...
  // Test that the Menubar will throw an error if an invalid submenusSelector is passed when the submenuItemsSelector is also passed.
  ...
  // Test that the Menubar will initialize if valid class lists are passed.
  it.each(classLists)(
  ...
  // Test that the Menubar will throw an error if an invalid class list is passed.
  it.each(classLists)(
  ...
  // Test that the Menubar will throw an error if isTopLevel not a boolean.
  ...
  // Test that the Menubar will throw an error is isTopLevel is false and no parentMenu is passed.
  ...
  // Test that the Menubar will initialize if isTopLevel is false and a parentMenu is passed.
  it("should initialize if isTopLevel is false and a parentMenu is passed", () => {
    // Create a new Menubar instance for testing.
    const parentMenu = new Menubar({
      menuElement: document.querySelector("ul"),
      isTopLevel: true,
    });
  ...
  // Test that the Menubar will throw an error if isTopLevel is false and an invalid parentMenu is passed.
  ...
  // Test that the Menubar will initialize if a valid parentMenu is passed.
  ...
  // Test that the Menubar will throw an error if an invalid parentMenu is passed.
  ...
  // Test that the Menubar will initialize if a valid hoverType is passed.
  ...
  // Test that the Menubar will throw an error if an invalid hoverType is passed.
  ...
  // Test that the Menubar will initialize if a valid hoverDelay is passed.
  ...
  // Test that the Menubar will throw an error if an invalid hoverDelay is passed.
  ...
  // Test that the Menubar will initialize if a valid enterDelay is passed.
  ...
  // Test that the Menubar will throw an error if an invalid enterDelay is passed.
  ...
  // Test that the Menubar will initialize if a valid leaveDelay is passed.
  ...
  // Test that the Menubar will throw an error if an invalid leaveDelay is passed.
  ...
  // Test that the Menubar will initialize if a valid prefix is passed.
  ...
  // Test that the Menubar will throw an error if an invalid prefix is passed.
  ...
  // Test that the Menubar will initialize if a valid key is passed.
  ...
  // Test that the Menubar will throw an error if an invalid key is passed.
...
// Menubar controlled initialization tests.
describe("Menubar (controlled initialization)", () => {
  ...
  it("should initialize if initialize is set to true", () => {
    ...
    expect(Menubar.prototype.initialize).toHaveBeenCalled();
  });
  ...
  it("should not initialize if initialize is set to false", () => {
    ...
    expect(Menubar.prototype.initialize).not.toHaveBeenCalled();
  });
});
