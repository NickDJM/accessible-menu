...
describe("Treeview", () => {
  ...
  describe.each(
    ...
    // Test the submenu toggle's aria-owns attribute.
    it("should set the submenu toggle's aria-owns attribute", () => {
      expect(toggle.dom.toggle.getAttribute("aria-owns")).toBe(
