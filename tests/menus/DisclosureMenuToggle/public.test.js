/**
 * Tests for public methods of the DisclosureMenuToggle class.
 */
...
// Test DisclosureMenuToggle public methods.
describe("DisclosureMenuToggle public methods", () => {
  // Test DisclosureMenuItem open().
  describe("open", () => {
  ...
  // Test DisclosureMenuToggle preview().
  describe("preview", () => {
  ...
  // Test DisclosureMenuToggle close().
  describe("close", () => {
  ...
  // Test DisclosureMenuToggle toggle().
  describe("toggle", () => {
    // Test that DisclosureMenuToggle implements the BaseMenuToggle toggle.
    it("should implement the BaseMenuToggle toggle", () => {
      expect(DisclosureMenuToggle.prototype.toggle).toBe(
        BaseMenuToggle.prototype.toggle
      );
    });
  });

  // Test DisclosureMenuToggle closeSiblings().
  describe("closeSiblings", () => {
    // Test that DisclosureMenuToggle implements the BaseMenuToggle closeSiblings.
    it("should implement the BaseMenuToggle closeSiblings", () => {
      expect(DisclosureMenuToggle.prototype.closeSiblings).toBe(
        BaseMenuToggle.prototype.closeSiblings
      );
    });
  });

  // Test DisclosureMenuToggle closeChildren().
  describe("closeChildren", () => {
    // Test that DisclosureMenuToggle implements the BaseMenuToggle closeChildren.
    it("should implement the BaseMenuToggle closeChildren", () => {
      expect(DisclosureMenuToggle.prototype.closeChildren).toBe(
