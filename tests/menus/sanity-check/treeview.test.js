...
describe("Treeview two-level menu sanity check", () => {
  // Mock console.error.
  console.error = jest.fn((error) => {
    throw new Error(error.message);
  });
  ...
  const menuItems = Array.from(menuElement.querySelectorAll("li"));
  const submenuItems = Array.from(menuElement.querySelectorAll("li.dropdown"));
  ...
  describe("has correct menu elements", () => {
    test("controller", () => {
      expect(menu.elements.controller.constructor.name).toBe("TreeviewToggle");
    });
    test("menuItems", () => {
      const isCorrectMenuItemClass = (element) =>
        element.constructor.name === "TreeviewItem";
    ...
    test("submenuToggles", () => {
      const isCorrectMenuToggleClass = (element) =>
        element.constructor.name === "TreeviewToggle";
  ...
  menu.elements.submenuToggles.forEach((toggle, index) => {
    ...
    describe("has correct dom elements", () => {
      ...
      test("menuItems", () => {
        const submenuItems = Array.from(submenuElement.querySelectorAll("li"));
    ...
    describe("has correct menu elements", () => {
      ...
      test("menuItems", () => {
        ...
        expect(submenu.elements.menuItems).toSatisfyAll(isCorrectMenuItemClass);
      });
      test("parentMenu", () => {
