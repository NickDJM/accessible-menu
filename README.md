...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.3/dist/accessible-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.3/dist/disclosure-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.3/dist/menubar.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.3/dist/top-link-disclosure-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.3/dist/treeview.min.js"></script>
```
