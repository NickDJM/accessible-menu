...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.2/dist/accessible-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.2/dist/disclosure-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.2/dist/menubar.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.2/dist/top-link-disclosure-menu.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/accessible-menu@4.0.0-beta.2/dist/treeview.min.js"></script>
```
