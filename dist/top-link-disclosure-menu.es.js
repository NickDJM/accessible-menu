...
class I {
  ...
  _expand(e = !0) {
    ...
    this.dom.toggle.setAttribute("aria-expanded", "true"), this.elements.controlledMenu.elements.rootMenu.hasOpened = !0, i !== "" ? (f(i, this.elements.controlledMenu.dom.menu), requestAnimationFrame(() => {
...
class A extends T {
  ...
  constructor({
    ...
    this._optionalSupport = j, this._selectors.menuItems = s, this._selectors.submenuItems = r, this._selectors.submenuToggles = l, this._selectors.submenus = h, this._selectors.submenuSubtoggles = c, this._selectors.menuLinks = [
  ...
  set optionalKeySupport(t) {
    m("boolean", { optionalKeySupport: t }), this._optionalSupport = t;
  }
  /**
   * Creates and initializes all menu items and submenus.
   *
  ...
  _createChildElements() {
    this.dom.menuItems.forEach((t) => {
      ...
      if (this.dom.submenuItems.includes(t)) {
        ...
        this._elements.submenuToggles.push(u), l !== r ? (i = new this._MenuItemType({
          menuItemElement: t,
          menuLinkElement: l,
          parentMenu: this,
          isSubmenuItem: !0,
    ...
    super._handleKeydown(), this.dom.menu.addEventListener("keydown", (t) => {
      ...
      if (this.focusState === "self") {
        ...
        this.optionalKeySupport ? [
          ...
          "Home",
          "End"
        ].includes(s) && a(t) : (this.currentMenuItem.isSubmenuItem && i.includes(s) || this.elements.controller && r.includes(s) || this.elements.parentMenu && l.includes(s)) && a(t);
      }
    });
  }
  /**
