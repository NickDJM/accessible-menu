var DisclosureMenu = (function () {
    ...
    try {
      ...
      for (const s in t)
        if (!(t[s] instanceof e)) {
          const n = typeof t[s];
          throw new TypeError(
            `AccessibleMenu: ${s} must be an instance of ${e.name}. ${n} given.`
          );
        }
      return !0;
    } catch (e) {
  ...
  function s(e, t) {
    try {
      ...
      for (const s in t) {
        ...
        if (n !== e)
          throw new TypeError(
            `AccessibleMenu: ${s} must be a ${e}. ${n} given.`
          );
      }
      return !0;
    } catch (e) {
  ...
  function l(e) {
    try {
      ...
      for (const s in e)
        if (!t.includes(e[s]))
          throw new TypeError(
            `AccessibleMenu: ${s} must be one of the following values: ${t.join(
              ", "
            )}. "${e[s]}" given.`
          );
      return !0;
  ...
  class i {
    constructor(t) {
      ...
      e(this, "_dom", { toggle: null, parent: null }),
        ...
        (this._dom.toggle = s),
        (this._dom.parent = n),
        (this._elements.controlledMenu = o),
    ...
    initialize() {
      if (
        ...
        (function (e, n) {
          if (s("string", { tagName: e }) && t(HTMLElement, n)) {
            const t = e.toLowerCase();
            let s = !0;
            for (const e in n) n[e].tagName.toLowerCase() !== t && (s = !1);
            return s;
          }
          return !1;
        ...
        !t.replace(/\s/g, "").length &&
          ...
          t.replace(/\s/g, "").length > 0 &&
            ...
            (s = `${t}-${s}`)),
          (this.dom.toggle.id = this.dom.toggle.id || `${s}-menu-button`),
          (this.elements.controlledMenu.dom.menu.id =
            this.elements.controlledMenu.dom.menu.id || `${s}-menu`);
      }
    ...
    set isOpen(e) {
      s("boolean", { value: e }), (this._open = e);
    }
    _expand() {
      let e =
      ...
      this.dom.toggle.setAttribute("aria-expanded", "true"),
        "" !== s &&
          ("string" == typeof s
            ? this.elements.controlledMenu.dom.menu.classList.add(s)
            : this.elements.controlledMenu.dom.menu.classList.add(...s)),
        "" !== t &&
          ("string" == typeof t
    ...
    _collapse() {
      ...
      this.dom.toggle.setAttribute("aria-expanded", "false"),
        ...
        "" !== s &&
          ("string" == typeof s
            ? this.elements.controlledMenu.dom.menu.classList.remove(s)
            : this.elements.controlledMenu.dom.menu.classList.remove(...s)),
  ...
  class r {
    constructor(t) {
      ...
      e(this, "_dom", { item: null, link: null }),
        ...
        (this._dom.item = s),
        (this._dom.link = n),
        (this._elements.parentMenu = o),
        (this._elements.childMenu = i),
        (this._elements.toggle = r),
        (this._submenu = l);
    }
    initialize() {}
    get dom() {
  ...
  function u(e) {
    try {
      ...
      return Object.keys(s).find((e) => !0 === s[e]) || "";
    } catch (e) {
      return "";
    }
  }
  ...
  class m {
    constructor(t) {
      ...
      e(this, "_MenuType", m),
        e(this, "_MenuItemType", r),
        e(this, "_MenuToggleType", i),
        e(this, "_dom", {
          menu: null,
          menuItems: [],
          submenuItems: [],
        ...
        (this._selectors.menuLinks = o),
        (this._selectors.submenuItems = l),
    ...
    set openClass(e) {
      o({ openClass: e }), this._openClass !== e && (this._openClass = e);
    }
    set closeClass(e) {
      o({ closeClass: e }), this._closeClass !== e && (this._closeClass = e);
    }
    set currentChild(e) {
      function t(e) {
        if (
          ...
          let t = 0,
            s = !1;
          for (; !s && t < e.elements.parentMenu.elements.menuItems.length; ) {
            const n = e.elements.parentMenu.elements.menuItems[t];
            n.isSubmenuItem &&
              n.elements.toggle.elements.controlledMenu === e &&
              ((s = !0),
    ...
    _validate() {
      ...
      return (
        ...
        "" === this._openClass || o({ openClass: this._openClass }) || (e = !1),
        "" === this._closeClass ||
          o({ closeClass: this._closeClass }) ||
          (e = !1),
        s("boolean", { isTopLevel: this._root }) || (e = !1),
        null === this._elements.parentMenu ||
          t(m, { parentMenu: this._elements.parentMenu }) ||
          (e = !1),
        l({ hoverType: this._hoverType }) || (e = !1),
        s("number", { hoverDelay: this._hoverDelay }) || (e = !1),
        e
      );
    }
    _setDOMElementType(e) {
        ...
        );
      {
        ...
        s !== this.dom.menu && t(HTMLElement, { base: s });
        const o = Array.from(s.querySelectorAll(this.selectors[e])).filter(
          (e) => e.parentElement === s
        );
        this._dom[e] = n ? o : [...this._dom[e], ...o];
      }
    }
    ...
    _handleClick() {
      ...
      this.elements.menuItems.forEach((t, s) => {
        t.dom.link.addEventListener(
          ...
          t.isSubmenuItem &&
            t.elements.toggle.dom.toggle.addEventListener("pointerup", (s) => {
              (this.currentEvent = "mouse"), e(this, t.elements.toggle, s);
            });
      }),
        this.isTopLevel &&
        ...
        e.dom.link.addEventListener("pointerenter", (s) => {
          if ("pen" !== s.pointerType && "touch" !== s.pointerType)
            if ("on" === this.hoverType)
              ...
              const s = this.elements.submenuToggles.some((e) => e.isOpen);
              (this.currentChild = t),
  ...
  class d extends m {
    constructor(t) {
      ...
      super({
        ...
        e(this, "_currentChild", -1),
        e(this, "_optionalSupport", !1),
        (this._optionalSupport = y),
        _ && this.initialize();
    }
    initialize() {
      try {
    ...
    set optionalKeySupport(e) {
      s("boolean", { optionalKeySupport: e }), (this._optionalSupport = e);
    }
    _validate() {
      let e = super._validate();
      return (
        s("boolean", { optionalKeySupport: this._optionalSupport }) || (e = !1),
        e
      );
    }
    _handleClick() {
        ...
        this.dom.menu.addEventListener("keydown", (e) => {
          ...
          if ("self" === this.focusState) {
            ...
            if (this.optionalKeySupport) {
              ...
              ((this.currentMenuItem.isSubmenuItem && s.includes(t)) ||
                (this.elements.controller && n.includes(t)) ||
                (this.elements.parentMenu && o.includes(t))) &&
                h(e);
          }
        });
    }
