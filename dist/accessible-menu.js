var AccessibleMenu = (function () {
  ...
  class BaseMenuToggle {
    constructor(_ref) {
      ...
      _defineProperty$7(this, "_expandEvent", new CustomEvent("accessibleMenuExpand", {
        bubbles: true,
        detail: {
          toggle: this
        }
      }));
      _defineProperty$7(this, "_collapseEvent", new CustomEvent("accessibleMenuCollapse", {
        bubbles: true,
        detail: {
          toggle: this
        }
  ...
  class BaseMenu {
    constructor(_ref) {
      ...
      _defineProperty$5(this, "_MenuType", BaseMenu);
      _defineProperty$5(this, "_MenuItemType", BaseMenuItem);
      _defineProperty$5(this, "_MenuToggleType", BaseMenuToggle);
  ...
  class DisclosureMenu extends BaseMenu {
    constructor(_ref) {
      ...
      _defineProperty$4(this, "_MenuType", DisclosureMenu);
      _defineProperty$4(this, "_MenuItemType", DisclosureMenuItem);
      _defineProperty$4(this, "_MenuToggleType", DisclosureMenuToggle);
      _defineProperty$4(this, "_currentChild", -1);
      _defineProperty$4(this, "_optionalSupport", false);
  ...
  class Menubar extends BaseMenu {
    constructor(_ref) {
      ...
      _defineProperty$3(this, "_MenuType", Menubar);
      _defineProperty$3(this, "_MenuItemType", MenubarItem);
      _defineProperty$3(this, "_MenuToggleType", MenubarToggle);
      if (initialize) {
        this.initialize();
      }
    }
  ...
  class TopLinkDisclosureMenuItem extends BaseMenuItem {
    constructor(_ref) {
      ...
      _defineProperty$2(this, "_elements", {
        parentMenu: null,
        childMenu: null,
        toggle: null,
        sibling: null
  ...
  class TopLinkDisclosureMenu extends BaseMenu {
    constructor(_ref) {
      ...
      _defineProperty$1(this, "_MenuType", TopLinkDisclosureMenu);
      _defineProperty$1(this, "_MenuItemType", TopLinkDisclosureMenuItem);
      _defineProperty$1(this, "_MenuToggleType", TopLinkDisclosureMenuToggle);
      _defineProperty$1(this, "_currentChild", -1);
      _defineProperty$1(this, "_optionalSupport", false);
      this._optionalSupport = optionalKeySupport;
