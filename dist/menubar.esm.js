  ...
  _createClass(BaseMenuToggle, [
    ...
    },
    {
      ...
      value: function closeChildren() {
        this.elements.controlledMenu.elements.submenuToggles.forEach(function (
          toggle
        ) {
          return toggle.close();
        });
  ...
  _createClass(MenubarItem, [
    {
      key: "initialize",
      value: function initialize() {
        _get(_getPrototypeOf(MenubarItem.prototype), "initialize", this).call(
          this
        );
  ...
  _createClass(Menubar, [
    {
      ...
      value: function initialize() {
        try {
          _get(_getPrototypeOf(Menubar.prototype), "initialize", this).call(
            this
          );
    ...
    },
    {
      ...
      value: function handleKeydown() {
        ...
        _get(_getPrototypeOf(Menubar.prototype), "handleKeydown", this).call(
          this
        );
    ...
    },
    {
      ...
      value: function handleKeyup() {
        ...
        _get(_getPrototypeOf(Menubar.prototype), "handleKeyup", this).call(
          this
        );
