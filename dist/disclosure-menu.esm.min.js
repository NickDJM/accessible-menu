...
function s(e, t) {
  try {
    ...
    for (const s in t) {
      const n = typeof t[s];
      if (n !== e)
        throw new TypeError(`AccessibleMenu: ${s} must be a ${e}. ${n} given.`);
    }
    return !0;
  } catch (e) {
    return console.error(e), !1;
...
class m {
  ...
  set hoverDelay(e) {
    s("number", { value: e }), this._hoverDelay !== e && (this._hoverDelay = e);
  }
  _validate() {
    let e = !0;
    return (
...
class d extends m {
  ...
  _validate() {
    ...
    return (
      s("boolean", { optionalKeySupport: this._optionalSupport }) || (e = !1), e
    );
  }
  _handleClick() {
    super._handleClick(),
