...
function c(n, e, { shouldThrow: t = !0 } = {}) {
  const s = {
    status: !0,
    errors: []
  };
...
function H(n, e, { shouldThrow: t = !0 } = {}) {
  const s = {
    status: !0,
    errors: []
  };
  try {
    if (l("string", { tagName: n }, { shouldThrow: !0 }).status && c(HTMLElement, e, { shouldThrow: !0 }).status) {
...
class F {
  ...
  _expand({ emit: e = !0, transition: t = !0 } = {}) {
    ...
    this.dom.toggle.setAttribute("aria-expanded", "true"), this.elements.controlledMenu.elements.rootMenu.hasOpened = !0, t && r !== "" ? (m(r, this.elements.controlledMenu.dom.menu), requestAnimationFrame(() => {
  ...
  _collapse({ emit: e = !0, transition: t = !0 } = {}) {
    ...
    this.dom.toggle.setAttribute("aria-expanded", "false"), t && r !== "" ? (m(r, this.elements.controlledMenu.dom.menu), requestAnimationFrame(() => {
...
class g {
  ...
  constructor({
    ...
    this._dom.menu = e, this._dom.controller = h, this._dom.container = a, this._selectors.menuItems = t, this._selectors.menuLinks = s, this._selectors.submenuItems = i, this._selectors.submenuToggles = r, this._selectors.submenus = o, this._elements.menuItems = [], this._elements.submenuToggles = [], this._elements.controller = null, this._elements.parentMenu = T, this._elements.rootMenu = f ? this : null, this._classes.open = y || "", this._classes.close = b || "", this._classes.transition = M || "", this._durations.transition = E, this._durations.open = C, this._durations.close = w, this._prefix = O || "", this._key = V || "", this._root = f, this._hoverType = k, this._delays.hover = v, this._delays.enter = I, this._delays.leave = S, this._breakpoint = A, this._mediaQueryString = D, this._shouldOpen = L;
  }
  /**
 ...
 - `)}`
  ...
  set focusState(e) {
    z({ focusState: e }), this._focusState !== e && (this._focusState = e), this.elements.submenuToggles.length > 0 && (e === "self" || e === "none") && this.elements.submenuToggles.forEach((t) => {
...
class Q extends g {
  ...
  _handleKeyup() {
    super._handleKeyup(), this._addEventListener("keyup", this.dom.menu, (e) => {
      this.currentEvent = "keyboard";
      const t = _(e), { altKey: s, crtlKey: i, metaKey: r } = e;
      if (t === "Character" && !(s || i || r))
        u(e), this.elements.rootMenu.currentEvent = "character", this.focusNextChildWithCharacter(e.key);
      else if (this.isTopLevel) {
        if (this.focusState === "self")
          if (t === "Space" || t === "Enter")
            u(e), this.currentMenuItem.isSubmenuItem ? (this.currentMenuItem.elements.childMenu.currentEvent = "keyboard", this.currentMenuItem.elements.toggle.open(), requestAnimationFrame(() => {
              this.currentMenuItem.elements.childMenu.focusFirstChild();
            })) : this.currentMenuItem.dom.link.click();
          else if (t === "ArrowRight") {
            u(e);
            const h = this.currentMenuItem.isSubmenuItem && this.currentMenuItem.elements.toggle.isOpen;
            this.focusNextChild(), h && (this.currentMenuItem.isSubmenuItem ? (this.currentMenuItem.elements.childMenu.currentEvent = "keyboard", this.currentMenuItem.elements.toggle.preview()) : this.closeChildren());
          } else if (t === "ArrowLeft") {
            u(e);
            const h = this.currentMenuItem.isSubmenuItem && this.currentMenuItem.elements.toggle.isOpen;
            this.focusPreviousChild(), h && (this.currentMenuItem.isSubmenuItem ? (this.currentMenuItem.elements.childMenu.currentEvent = "keyboard", this.currentMenuItem.elements.toggle.preview()) : this.closeChildren());
          } else t === "ArrowDown" ? this.currentMenuItem.isSubmenuItem && (u(e), this.currentMenuItem.elements.childMenu.currentEvent = "keyboard", this.currentMenuItem.elements.toggle.open(), requestAnimationFrame(() => {
            this.currentMenuItem.elements.childMenu.focusFirstChild();
        ...
        t === "Space" || t === "Enter" ? (u(e), this.currentMenuItem.isSubmenuItem ? (this.currentMenuItem.elements.childMenu.currentEvent = "keyboard", this.currentMenuItem.elements.toggle.open(), requestAnimationFrame(() => {
          this.currentMenuItem.elements.childMenu.focusFirstChild();
  ...
  focusNextChildWithCharacter(e) {
    ...
    for (; !i && s < this.elements.menuItems.length; ) {
      let r = "";
      this.elements.menuItems[s].dom.item.innerText ? r = this.elements.menuItems[s].dom.item.innerText : r = this.elements.menuItems[s].dom.item.textContent, r = r.replace(/[\s]/g, "").toLowerCase().charAt(0), r === t && (i = !0, this.focusChild(s)), s++;
    }
  }
}
export {
