var AccessibleMenu = (function () {
  ...
  function t(e, t) {
    try {
      ...
      for (const n in t) {
        ...
        if (s !== e)
          throw new TypeError(
            `AccessibleMenu: ${n} must be a ${e}. ${s} given.`
          );
      }
      return !0;
    } catch (e) {
      ...
      for (const t in e) {
        ...
        if ("string" !== s) {
          if (!Array.isArray(e[t]))
            throw new TypeError(
              `AccessibleMenu: ${t} must be a string or an array of strings. ${s} given.`
            );
          e[t].forEach((e) => {
            if ("string" != typeof e)
              throw new TypeError(
  ...
  class l {
    constructor(e) {
      ...
      i(this, "_dom", { toggle: null, parent: null }),
        i(this, "_elements", { controlledMenu: null, parentMenu: null }),
        i(this, "_open", !1),
        i(
          this,
          "_expandEvent",
    ...
    initialize() {
      if (
        ...
        (function (n, s) {
          if (t("string", { tagName: n }) && e(HTMLElement, s)) {
            const e = n.toLowerCase();
            let t = !0;
            for (const n in s) s[n].tagName.toLowerCase() !== e && (t = !1);
            return t;
          }
          return !1;
    ...
    set isOpen(e) {
      t("boolean", { value: e }), (this._open = e);
    }
    _expand() {
      let e =
  ...
  class a {
    constructor(e) {
      ...
      c(this, "_MenuType", a),
        c(this, "_MenuItemType", u),
        c(this, "_MenuToggleType", l),
        c(this, "_dom", {
          menu: null,
          menuItems: [],
          submenuItems: [],
        ...
        c(this, "_openClass", "show"),
        c(this, "_closeClass", "hide"),
        c(this, "_root", !0),
        c(this, "_currentChild", 0),
        c(this, "_focusState", "none"),
        c(this, "_currentEvent", "none"),
        c(this, "_hoverType", "off"),
        c(this, "_hoverDelay", 250),
        (this._dom.menu = t),
        (this._dom.controller = h),
        (this._dom.container = m),
        (this._selectors.menuItems = n),
        (this._selectors.menuLinks = s),
        (this._selectors.submenuItems = r),
        (this._selectors.submenuToggles = i),
        (this._selectors.submenus = o),
    ...
    set currentChild(e) {
      ...
      t("number", { value: e }),
        e < -1
          ? ((this._currentChild = -1), n(this))
          : e >= this.elements.menuItems.length
          ? ((this._currentChild = this.elements.menuItems.length - 1), n(this))
          : this.focusChild !== e && ((this._currentChild = e), n(this));
    }
    set focusState(e) {
      !(function (e) {
        try {
    ...
    set hoverDelay(e) {
      t("number", { value: e }),
        this._hoverDelay !== e && (this._hoverDelay = e);
    }
    _validate() {
      let i = !0;
      return (
        null !== this._dom.container || null !== this._dom.controller
          ...
          : e(HTMLElement, { menuElement: this._dom.menu }) || (i = !1),
        ...
        "" === this._openClass || s({ openClass: this._openClass }) || (i = !1),
        "" === this._closeClass ||
          s({ closeClass: this._closeClass }) ||
          (i = !1),
        t("boolean", { isTopLevel: this._root }) || (i = !1),
        null === this._elements.parentMenu ||
          e(a, { parentMenu: this._elements.parentMenu }) ||
          (i = !1),
        r({ hoverType: this._hoverType }) || (i = !1),
        t("number", { hoverDelay: this._hoverDelay }) || (i = !1),
        i
      );
    }
    _setDOMElementType(t) {
      ...
      if ("string" != typeof this.selectors[t])
        throw new Error(
        ...
        );
      {
        ...
        n !== this.dom.menu && e(HTMLElement, { base: n });
        const r = Array.from(n.querySelectorAll(this.selectors[t])).filter(
          (e) => e.parentElement === n
        );
        this._dom[t] = s ? r : [...this._dom[t], ...r];
      }
    }
      ...
      this.dom.menuItems.forEach((e) => {
        ...
        if (this.dom.submenuItems.includes(e)) {
          const n = e.querySelector(this.selectors.submenuToggles),
            ...
            i = new this._MenuToggleType({
              menuToggleElement: n,
              parentElement: e,
              controlledMenu: r,
              parentMenu: this,
            });
          this._elements.submenuToggles.push(i),
      ...
      this.elements.menuItems.forEach((t, n) => {
        ...
        this.isTopLevel &&
          ...
          this.elements.controller.dom.toggle.addEventListener(
            ...
            (t) => {
              (this.currentEvent = "mouse"),
                e(this, this.elements.controller, t);
            }
          );
    }
    _handleHover() {
    ...
    _handleKeyup() {
      this.isTopLevel &&
        ...
        this.elements.controller.dom.toggle.addEventListener("keyup", (e) => {
          ...
          const t = h(e);
          ("Space" !== t && "Enter" !== t) ||
            (m(e), this.elements.controller.open(), this.focusFirstChild());
        });
    }
    focus() {
  ...
  class f extends a {
    constructor(e) {
      ...
      super({
        ...
        g(this, "_MenuType", f),
        g(this, "_MenuItemType", d),
        g(this, "_MenuToggleType", p),
        g(this, "_currentChild", -1),
        g(this, "_optionalSupport", !1),
        (this._optionalSupport = v),
        y && this.initialize();
    }
    initialize() {
      try {
    ...
    set optionalKeySupport(e) {
      t("boolean", { optionalKeySupport: e }), (this._optionalSupport = e);
    }
    _validate() {
      let e = super._validate();
      return (
        t("boolean", { optionalKeySupport: this._optionalSupport }) || (e = !1),
        e
      );
    }
    _handleClick() {
          ...
          if ("self" === this.focusState) {
            ...
            if (this.optionalKeySupport) {
              ...
              ((this.currentMenuItem.isSubmenuItem && n.includes(t)) ||
                ...
                (this.elements.parentMenu && r.includes(t))) &&
                m(e);
          }
        });
    }
        ...
        this.dom.menu.addEventListener("keyup", (e) => {
          ...
          if ("self" === this.focusState)
            if ("Space" === t || "Enter" === t)
              ...
              this.elements.submenuToggles.some((e) => e.isOpen)
                ? (m(e), this.closeChildren())
                : this.elements.parentMenu
                ? (m(e),
                ...
                ("ArrowDown" === t || "ArrowRight" === t
                  ? (m(e),
                    ...
                    this.currentMenuItem.elements.toggle.isOpen
                      ...
                      : this.focusNextChild())
                  : "ArrowUp" === t || "ArrowLeft" === t
                  ? (m(e), this.focusPreviousChild())
                  : "Home" === t
                  ? (m(e), this.focusFirstChild())
                  : "End" === t && (m(e), this.focusLastChild()));
        });
    }
  }
  class b extends u {
  ...
  class y extends a {
    constructor(e) {
      ...
      super({
        ...
        v(this, "_MenuType", y),
        v(this, "_MenuItemType", b),
        v(this, "_MenuToggleType", M),
        g && this.initialize();
    }
    initialize() {
      try {
      ...
      super._handleKeydown(),
        this.dom.menu.addEventListener("keydown", (e) => {
          ...
          if (
            ...
            if ("self" === this.focusState) {
              const n = ["Space", "Enter", "ArrowDown", "ArrowUp"],
                s = ["Escape"];
    ...
    _handleKeyup() {
      super._handleKeyup(),
        this.dom.menu.addEventListener("keyup", (e) => {
          this.currentEvent = "keyboard";
          const t = h(e),
            { altKey: n, crtlKey: s, metaKey: r } = e;
          if ("Character" !== t || n || s || r)
            if (this.isTopLevel) {
              if ("self" === this.focusState)
                if ("Space" === t || "Enter" === t)
                  this.currentMenuItem.isSubmenuItem
                ...
                else if ("Home" === t) m(e), this.focusFirstChild();
                else if ("End" === t) m(e), this.focusLastChild();
                else if ("Escape" === t) {
                  this.elements.submenuToggles.some((e) => e.isOpen)
                    ? (m(e), this.closeChildren())
                    : this.isTopLevel &&
    ...
    focusNextChildWithCharacter(e) {
      ...
      let n = this.currentChild + 1,
        s = !1;
      for (; !s && n < this.elements.menuItems.length; ) {
        let e = "";
        (e = this.elements.menuItems[n].dom.item.innerText
          ? this.elements.menuItems[n].dom.item.innerText
          : this.elements.menuItems[n].dom.item.textContent),
          (e = e.replace(/[\s]/g, "").toLowerCase().charAt(0)),
          e === t && ((s = !0), this.focusChild(n)),
          n++;
      }
    }
  }
  ...
  class _ extends a {
    constructor(e) {
      ...
      super({
        ...
        I(this, "_MenuType", _),
        I(this, "_MenuItemType", E),
        I(this, "_MenuToggleType", C),
        g && this.initialize();
    }
    initialize() {
      try {
            ...
            if ("self" === this.focusState)
              if ("Enter" === t || "Space" === t)
                ...
                "ArrowRight" === t
                  ...
                  : "Asterisk" === t && (m(e), this.openChildren());
          } else
            m(e),
              (this.elements.rootMenu.currentEvent = "character"),
    ...
    focusNextNodeWithCharacter(e) {
      const t = e.toLowerCase(),
        ...
        r = [...n.slice(s), ...n.slice(0, s)];
      let i = 0,
        l = !1;
      for (; !l && i < r.length; ) {
        let e = "";
        if (
          ((e = r[i].dom.item.innerText
            ? r[i].dom.item.innerText
            : r[i].dom.item.textContent),
          (e = e.replace(/[\s]/g, "").toLowerCase().charAt(0)),
          e === t)
        ) {
          l = !0;
          const e = r[i].elements.parentMenu,
            t = e.elements.menuItems.indexOf(r[i]);
    ...
    focusChildsLastNode() {
      (this.currentMenuItem.elements.childMenu.currentEvent =
        ...
        this.currentMenuItem.elements.childMenu.currentMenuItem.isSubmenuItem &&
          this.currentMenuItem.elements.childMenu.currentMenuItem.elements
            .toggle.isOpen &&
          (this.currentMenuItem.elements.childMenu.blurCurrentChild(),
          this.currentMenuItem.elements.childMenu.focusChildsLastNode());
    }
  }
  return { DisclosureMenu: f, Menubar: y, Treeview: _ };
})();
